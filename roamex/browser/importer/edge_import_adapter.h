...
#ifndef ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_ADAPTER_H_
#define ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_ADAPTER_H_
...
#endif  // ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_ADAPTER_H_
