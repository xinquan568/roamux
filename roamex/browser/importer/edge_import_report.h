...
#ifndef ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_REPORT_H_
#define ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_REPORT_H_
...
enum class CarrierStatus {
  ...
  kFeatureDisabled,  // roamex::kEdgeImport was off
};
...
#endif  // ROAMEX_BROWSER_IMPORTER_EDGE_IMPORT_REPORT_H_
