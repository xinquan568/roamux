...
#ifndef ROAMEX_BROWSER_IMPORTER_EDGE_SECRET_DECRYPTOR_H_
#define ROAMEX_BROWSER_IMPORTER_EDGE_SECRET_DECRYPTOR_H_
...
#endif  // ROAMEX_BROWSER_IMPORTER_EDGE_SECRET_DECRYPTOR_H_
