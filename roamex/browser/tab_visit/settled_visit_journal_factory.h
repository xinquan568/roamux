...
#ifndef ROAMEX_BROWSER_TAB_VISIT_SETTLED_VISIT_JOURNAL_FACTORY_H_
#define ROAMEX_BROWSER_TAB_VISIT_SETTLED_VISIT_JOURNAL_FACTORY_H_
...
#endif  // ROAMEX_BROWSER_TAB_VISIT_SETTLED_VISIT_JOURNAL_FACTORY_H_
