...
#ifndef ROAMEX_BROWSER_TAB_VISIT_TAB_TRAVERSAL_CONTROLLER_H_
#define ROAMEX_BROWSER_TAB_VISIT_TAB_TRAVERSAL_CONTROLLER_H_
...
// dependency; the durable identity SOURCE (RoamexTabDurableId / §13.2) and the
...
#endif  // ROAMEX_BROWSER_TAB_VISIT_TAB_TRAVERSAL_CONTROLLER_H_
