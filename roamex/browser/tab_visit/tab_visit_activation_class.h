...
#ifndef ROAMEX_BROWSER_TAB_VISIT_TAB_VISIT_ACTIVATION_CLASS_H_
#define ROAMEX_BROWSER_TAB_VISIT_TAB_VISIT_ACTIVATION_CLASS_H_
...
// the pure `//roamex/browser/tab_visit` source_set. The observer bridge (which
...
#endif  // ROAMEX_BROWSER_TAB_VISIT_TAB_VISIT_ACTIVATION_CLASS_H_
