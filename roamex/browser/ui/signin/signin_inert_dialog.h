...
#ifndef ROAMEX_BROWSER_UI_SIGNIN_SIGNIN_INERT_DIALOG_H_
#define ROAMEX_BROWSER_UI_SIGNIN_SIGNIN_INERT_DIALOG_H_
...
// roamex-owned file inside the upstream target, so it may use chrome/browser
...
#endif  // ROAMEX_BROWSER_UI_SIGNIN_SIGNIN_INERT_DIALOG_H_
