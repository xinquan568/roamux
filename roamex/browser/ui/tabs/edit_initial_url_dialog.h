...
#ifndef ROAMEX_BROWSER_UI_TABS_EDIT_INITIAL_URL_DIALOG_H_
#define ROAMEX_BROWSER_UI_TABS_EDIT_INITIAL_URL_DIALOG_H_
...
#endif  // ROAMEX_BROWSER_UI_TABS_EDIT_INITIAL_URL_DIALOG_H_
