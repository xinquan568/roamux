...
#ifndef ROAMEX_BROWSER_UI_TABS_TAB_STRIP_POSITION_MENU_H_
#define ROAMEX_BROWSER_UI_TABS_TAB_STRIP_POSITION_MENU_H_
...
// chrome/browser/ui/tabs/existing_base_sub_menu_model.h (1001–1900); roamex
// takes 2101+.
...
// roamex::TabStripPlacement values).
inline constexpr int kTabStripPositionFirstItemCommandId = 2102;

// The flag-gated "Tab strip position (Roamex)" submenu for the tab context
// menu: four radio items whose checked state mirrors
// roamex::prefs::kTabStripPosition and whose activation writes it. Acts as its
...
// When roamex::features::kTabStripPosition is enabled, appends a separator +
...
#endif  // ROAMEX_BROWSER_UI_TABS_TAB_STRIP_POSITION_MENU_H_
