...
// The product URL scheme ("roamex://…"), roam-91. Registered as a standard
...
// agreement).
inline constexpr char kRoamexScheme[] = "roamex";
...
// roamex:// alias hosts (roam-91): the curated alias map rewrites
// roamex://about → chrome://roamex-about and roamex://flags → chrome://flags.
