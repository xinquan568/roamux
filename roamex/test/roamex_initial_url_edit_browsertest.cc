...
// roamex_initial_url_restore_browsertest.cc.
...
class RoamexInitialUrlEditTest : public InProcessBrowserTest {
 public:
  RoamexInitialUrlEditTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexInitialUrlEditTest, EditDialogSeamLocksValue) {
...
IN_PROC_BROWSER_TEST_F(RoamexInitialUrlEditTest, SetToCurrentPageLocks) {
...
IN_PROC_BROWSER_TEST_F(RoamexInitialUrlEditTest, ReopenClosedRestoresValue) {
...
IN_PROC_BROWSER_TEST_F(RoamexInitialUrlEditFlagOffTest, NoHelperWhenFlagOff) {
