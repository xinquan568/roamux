...
using RoamexOriginStorageImportTest = InProcessBrowserTest;

IN_PROC_BROWSER_TEST_F(RoamexOriginStorageImportTest,
  ...
  RoamexOriginStorageImportStage stage(edge.GetPath(), profile);
