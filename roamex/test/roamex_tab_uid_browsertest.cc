...
class RoamexTabUidTest : public InProcessBrowserTest {
 public:
  RoamexTabUidTest() { features_.InitAndEnableFeature(features::kInitialUrl); }
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidTest, EveryLiveTabHasADistinctUid) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidTest, DuplicateMintsFresh) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidTest, ReopenReusesTheClosedTabsUid) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidTest, LiveCollisionRestamps) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidTest, OtrIsIsolatedAndUnpersisted) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabUidFlagOffTest, NoHelperNoUidWhenFlagOff) {
  content::WebContents* web_contents =
