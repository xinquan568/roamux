...
class RoamexTabVisitGestureTest : public InProcessBrowserTest {
 public:
  RoamexTabVisitGestureTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureTest, OneAppendPerGesture) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureTest,
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureTest, CommandEnablement) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureTest, TailCoalescing) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureTest, SettleOnDeadLandedTab) {
...
class RoamexTabVisitGestureFlagOffTest : public InProcessBrowserTest {
 public:
  RoamexTabVisitGestureFlagOffTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitGestureFlagOffTest, CommandsDisabled) {
