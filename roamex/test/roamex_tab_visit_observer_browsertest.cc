...
class RoamexTabVisitObserverTest : public InProcessBrowserTest {
 public:
  RoamexTabVisitObserverTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitObserverTest, UserSelectionIsCommitted) {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitObserverTest, ApiActivationIsCommitted) {
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), UrlA()));
  ASSERT_TRUE(AddTabAtIndex(1, UrlB(), ui::PAGE_TRANSITION_TYPED));
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitObserverTest,
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitObserverTest, EmptyAndNtpNotRecorded) {
...
class RoamexTabVisitObserverFlagOffTest : public InProcessBrowserTest {
 public:
  RoamexTabVisitObserverFlagOffTest() {
...
IN_PROC_BROWSER_TEST_F(RoamexTabVisitObserverFlagOffTest,
