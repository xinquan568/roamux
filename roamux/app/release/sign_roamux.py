...
import roamux_signing_config  # noqa: F401,E402
...
def main():
    ...
    if base is not None:
        roamux_cfg_cls = roamux_signing_config.make_roamux_config_class(base)
        print(f"using {roamux_cfg_cls.__name__} "
              f"(product={roamux_cfg_cls().app_product})")
    ...
    # runtime; sign_chrome derives the ordered parts from RoamuxCodeSignConfig.
    _run([sys.executable,
