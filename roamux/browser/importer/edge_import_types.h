...
#ifndef ROAMUX_BROWSER_IMPORTER_EDGE_IMPORT_TYPES_H_
#define ROAMUX_BROWSER_IMPORTER_EDGE_IMPORT_TYPES_H_
...
#endif  // ROAMUX_BROWSER_IMPORTER_EDGE_IMPORT_TYPES_H_
