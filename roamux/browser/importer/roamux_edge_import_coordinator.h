...
#ifndef ROAMUX_BROWSER_IMPORTER_ROAMUX_EDGE_IMPORT_COORDINATOR_H_
#define ROAMUX_BROWSER_IMPORTER_ROAMUX_EDGE_IMPORT_COORDINATOR_H_
...
class RoamuxEdgeImportCoordinator {
 public:
  ...
  RoamuxEdgeImportCoordinator(const RoamuxEdgeImportCoordinator&) = delete;
  RoamuxEdgeImportCoordinator& operator=(const RoamuxEdgeImportCoordinator&) =
      delete;
  ~RoamuxEdgeImportCoordinator();
 ...
 private:
  ...
  std::unique_ptr<RoamuxSecretImportStage> secret_stage_;
  std::unique_ptr<RoamuxOriginStorageImportStage> localstorage_stage_;
  std::unique_ptr<RoamuxIndexedDbImportStage> indexeddb_stage_;

  EdgeImportReport report_;
  base::OnceCallback<void(EdgeImportReport)> done_;

  base::WeakPtrFactory<RoamuxEdgeImportCoordinator> weak_factory_{this};
};

}  // namespace roamux

#endif  // ROAMUX_BROWSER_IMPORTER_ROAMUX_EDGE_IMPORT_COORDINATOR_H_
