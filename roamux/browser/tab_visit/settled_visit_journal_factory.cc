...
constexpr base::FilePath::CharType kJournalDbName[] =
    FILE_PATH_LITERAL("RoamuxTabVisits");
...
// the low //roamux/browser/tab_visit registry from the factory ctor. It runs on
...
SettledVisitJournalFactory::SettledVisitJournalFactory()
    : ProfileKeyedServiceFactory(
          "RoamuxSettledVisitJournalService",
