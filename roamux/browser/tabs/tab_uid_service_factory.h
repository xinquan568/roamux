...
#ifndef ROAMUX_BROWSER_TABS_TAB_UID_SERVICE_FACTORY_H_
#define ROAMUX_BROWSER_TABS_TAB_UID_SERVICE_FACTORY_H_
...
#endif  // ROAMUX_BROWSER_TABS_TAB_UID_SERVICE_FACTORY_H_
