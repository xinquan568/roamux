...
#ifndef ROAMUX_BROWSER_TABS_TAB_UID_TAB_HELPER_H_
#define ROAMUX_BROWSER_TABS_TAB_UID_TAB_HELPER_H_
...
// TabFeatures::Init via patch 0009 when roamux::features::kInitialUrl is on.
...
class TabUidTabHelper : public content::WebContentsUserData<TabUidTabHelper> {
 public:
  static constexpr char kExtraDataKey[] = "roamux.tab_uid";
...
#endif  // ROAMUX_BROWSER_TABS_TAB_UID_TAB_HELPER_H_
