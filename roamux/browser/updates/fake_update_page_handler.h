...
#ifndef ROAMUX_BROWSER_UPDATES_FAKE_UPDATE_PAGE_HANDLER_H_
#define ROAMUX_BROWSER_UPDATES_FAKE_UPDATE_PAGE_HANDLER_H_
...
#endif  // ROAMUX_BROWSER_UPDATES_FAKE_UPDATE_PAGE_HANDLER_H_
