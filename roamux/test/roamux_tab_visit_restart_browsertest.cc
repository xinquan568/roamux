...
// row is persisted).
IN_PROC_BROWSER_TEST_F(RoamuxTabVisitRestartTest,
...
// failure mode.)
IN_PROC_BROWSER_TEST_F(RoamuxTabVisitRestartTest, RestartReloadsUidJournal) {
...
IN_PROC_BROWSER_TEST_F(RoamuxTabVisitNoRestoreTest,
